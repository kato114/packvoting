  ...
  <TheLayout>
        ...
        <div class="flex flex-auto items-center">
          ...
          >
            <button
              ...
              class="m'l'-3 rounded-full bg-amber-500 py-2 px-3 text-white hover:bg-amber-700"
            >
              {{ $t('proposals.new') }}
            </button>
          </router-link>
    ...
    <div v-else class="my-4 space-y-4">
      <BaseBlock
        ...
        :key="i"
        slim
        class="transition-colors bg-zinc-900 border-amber-500 md:hover:border-amber-600"
      >
        <ProposalsItem
          :proposal="proposal"
          :profiles="profiles"
